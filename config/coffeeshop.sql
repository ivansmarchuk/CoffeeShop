...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 05 2018 г., 03:04
...
(3, 'user2', '$2y$10$96vo42W73KsFM.Q73ncJ7.kRcnoXvvV8Zu10fcaLIFi9AzTCCCFUy', '2@test.com', 'user2', 'newAdress', 'user'),
(4, 'user3', '$2y$10$Uha8ddk9xyGI/WH3u2mtBOpA0Gci5NSp.hucxE9PVnbvO6dJYsV9m', '3@3.com', 'User3', 'Speyerer str', 'user'),
(5, 'user4', '$2y$10$KqIyzTqjPc97A1WmTRuZQ.lqLFeK0ds9UycJcJMzJ7gl6fgBgBgQ6', '4@test.com', 'user1', 'asdw', 'user'),
(6, 'user1', '$2y$10$z5VtvTbIMC60qm.LMxKshOxuAcbs6QnMZUk4FRKZKMRAT30RMJqVO', '1@test.com', 'user1', 'Jersystr', 'user'),
(7, 'user5', '$2y$10$1qg.ez.pG0RBn0K5mPaZzuqO2G7zwYqfRd8hxWWk5MAP7thvtdYmq', '5@test.com', 'user5', 'SuperAddress', 'user'),
(8, 'user6', '$2y$10$jRUp/w3aFk55V.VdIOAYiu2/.J9go2G86c1tr6IZs.nOC1tNERmqm', '6@test.com', 'user6', 'address', 'user'),
(9, 'user7', '$2y$10$qWVHVNsoe33i1htfVB0NzO31yYbYiw3pJ3ijKB0gYRE6F7MbL6ot.', '7@test.com', 'user7', '77777', 'user');
